...
The comments notably, were just consisting of their text content and the author avatar.
...
This made us add a small notification showing when bookmarking a comment or an idea.
...
To prevent this reaction, we added a comment counter in the idea main view
...
Then, in the idea view, she saw the comment counter and wanted to see the discussion by clicking on the counter, which was not working.
...
The simple fact that we feel the need to explain it here means that it requires clarification and that is why we simply changed it to the number of ideas in which you wrote at least one comment.
