...
\begin{abstract}
    ...
    Unfortunately, it was not implemented because we chose to prioritize user testing.
    We were able to improve the front-end and verify some of our assumptions by doing three test sessions.
    This is a bit weak to make strong conclusions, but the feedback we got is promising and tells us we are going in the right direction.
...
\begin{figure}[!htb]
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=.67\textwidth]{images/classificationSelect_selected.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.48\textwidth}
        \centering
        \includegraphics[width=.67\textwidth]{images/classificationSelect_selecting.png}
    \end{subfigure}
