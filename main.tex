...
% - plan better in order to be able to do both user testing and back-end implementation
% - if we could have had both, we could have been able to test interaction between users and notice how it could have improved collaboration
% - more user testing => more feedback => more solid conclusions

% What is still to be done
% - back-end (database, better recap algorithm, live communication through chat, live sync between different devices)
