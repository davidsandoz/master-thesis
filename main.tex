...
\caption{Screenshots of Flok front-end featuring the activity of the platform}
\label{fig.activity}
\end{figure}
...
\caption{Screenshots of Flok front-end featuring the message view. The message is highlighted, above we have the message it is replying to and below we have the replies.}
...
We wanted to make these relations more visible and therefore implemented a simple visualization showing two levels of parents and children forks (see figure \ref{fig.fork})
%TODO insert figure for fork (idea view with indication of parents and children + fork visualization)
