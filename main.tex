...
\color{white}
\newcommand{\epflLogo}{logos/logo_EPFL_White.pdf}
\newcommand{\niLogo}{logos/NothingInteractive_RGB_White_Vertical.pdf}
\input{./title.tex}
\thispagestyle{empty}
\cleardoublepage
...
\pagecolor{white}
\color{black}
\renewcommand{\epflLogo}{logos/logo_EPFL.pdf}
\renewcommand{\niLogo}{logos/NothingInteractive_RGB_Color_Vertical.pdf}
\setcounter{page}{1}
\pagenumbering{roman}
\input{./title.tex}
\cleardoublepage
...
\begin{wrapfigure}[6]{r}[0pt]{1.8cm}
    \vspace{-13pt}
    \begin{subfigure}[t]{1.8cm}
        \centering
        \begin{tikzpicture}
            \begin{scope}
                \clip [rounded corners=.8cm] (0,0) rectangle coordinate (centerpoint) (1.6,1.6cm);
                \node [inner sep=0pt] at (centerpoint) {\includegraphics[width=1.6cm]{images/userA.jpg}};
            \end{scope}
        \end{tikzpicture}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{1.8cm}
        ...
        \begin{tikzpicture}
            \begin{scope}
                \clip [rounded corners=.8cm] (0,0) rectangle coordinate (centerpoint) (1.6,1.6cm);
                \node [inner sep=0pt] at (centerpoint) {\includegraphics[width=1.6cm]{images/userC.jpg}};
            \end{scope}
        \end{tikzpicture}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{1.8cm}
        ...
        \begin{tikzpicture}
            \begin{scope}
                \clip [rounded corners=.8cm] (0,0) rectangle coordinate (centerpoint) (1.6,1.6cm);
                \node [inner sep=0pt] at (centerpoint) {\includegraphics[width=1.6cm]{images/userB.jpg}};
            \end{scope}
        \end{tikzpicture}
    \end{subfigure}
    \label{fig.personas}
