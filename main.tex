...
You will notice in equation \ref{eq.messageWeightInRecap} that some of the message properties are weighted with different factors. %TODO explain factors
