...
%TODO add screenshot of ideas three views
...
When clicking on one, we are brought to the hashtag view, which list all occurrences of the hashtag in all ideas.
They are also going to be used in the recap view that we are talking about in section \ref{sec.recap}.
%TODO add screenshot of hashtag page
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=.32\textwidth]{images/messageView.png}
...
%TODO add screenshot of recap view from mobile and desktop
