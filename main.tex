...
Figure \ref{fig.flokUsmCurrent} shows you its state at the time of handing in the report.
...
% TODO Still subject to change until I hand in the report.
\begin{figure}[!htb]
\centering
...
% TODO Not easy to do a User Story Map because of the real-time aspect of the project (realized while doing USM for Tawuala)
